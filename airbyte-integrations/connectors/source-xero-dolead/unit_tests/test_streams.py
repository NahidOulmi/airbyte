...
import pytest
from source_xero_dolead.source import XeroDoleadStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(XeroDoleadStream, "path", "v0/example_endpoint")
    mocker.patch.object(XeroDoleadStream, "primary_key", "test_primary_key")
    mocker.patch.object(XeroDoleadStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = XeroDoleadStream()
